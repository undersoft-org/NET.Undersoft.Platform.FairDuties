...
using Undersoft.IDP.Admin.BusinessLogic.Identity.Events.Identity;
...
using Undersoft.IDP.Admin.BusinessLogic.Shared.ExceptionHandling;
...
namespace Undersoft.IDP.Admin.BusinessLogic.Identity.Services
{
