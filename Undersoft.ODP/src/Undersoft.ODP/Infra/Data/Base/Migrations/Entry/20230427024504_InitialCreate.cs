        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfilesToContacts_Locales_RightEntityId",
                        column: x => x.RightEntityId,
                        principalSchema: "Local",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Addresses_Locales_ContactId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Vectors_Groups_GroupViewId",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vectors_Groups_VectorId",
                        column: x => x.VectorId,
                        principalSchema: "Local",
                        principalTable: "Groups",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Duties_Vectors_VectorId",
                        column: x => x.VectorId,
                        principalSchema: "Local",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DutysToVectors_Vectors_RightEntityId",
                        column: x => x.RightEntityId,
                        principalSchema: "Local",
                        principalTable: "Vectors",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vectors_GroupViewId",
                schema: "Local",
                table: "Vectors",
                column: "GroupViewId");

            migrationBuilder.CreateIndex(
                name: "IX_Vectors_Ordinal",
                schema: "Local",
                table: "Vectors",
                column: "Ordinal");

            migrationBuilder.CreateIndex(
                name: "IX_Vectors_VectorId",
                schema: "Local",
                table: "Vectors",
                column: "VectorId",
                unique: true);
