...
namespace Undersoft.ODP.Api.Data.Service.Operation.Controllers.Entries
{
    ...
    public class ShiftRateController : DsoController<long, IEntryStore, ShiftRate>
    {
        public ShiftRateController(IUltimatr ultimatr) : base(ultimatr) { }
    }
}
...
namespace Undersoft.ODP.Api.Data.Service.Operation.Controllers.Reports
{
    ...
    public class ShiftRateController : DsoController<long, IReportStore, ShiftRate>
    {
        public ShiftRateController(IUltimatr ultimatr) : base(ultimatr) { }
    }
}