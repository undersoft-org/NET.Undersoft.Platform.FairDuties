...
namespace UltimatR
{
    public class DeleteDtoSet<TStore, TEntity, TDto> : DtoCommandSet<TDto> where TEntity : Entity where TDto : Dto where TStore : IDataStore
    {
        ...
        public DeleteDtoSet(PublishMode publishPattern, object key)
      : base(CommandMode.Create, publishPattern, new[] { new DeleteDto<TStore, TEntity, TDto>(publishPattern, key) }) { }
