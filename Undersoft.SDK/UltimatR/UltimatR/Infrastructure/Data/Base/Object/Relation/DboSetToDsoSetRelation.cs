...
namespace UltimatR
{
    public class DboSetToDsoSetRelation<TLeft, TRight>
		where TLeft : Entity
		where TRight : Entity
	{
		...
		private readonly EntityTypeBuilder<DboRelation<TLeft, TRight>> _relationBuilder;

		public DboSetToDsoSetRelation(
		...
		)
		{
			...
			_relationBuilder = _modelBuilder.Entity<DboRelation<TLeft, TRight>>();
		...
		public ModelBuilder Configure()
		{
			...
			_firstBuilder
				.HasMany<DboRelation<TLeft, TRight>>(RELATION_TABLE_NAME)
