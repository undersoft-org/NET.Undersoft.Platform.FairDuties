...
namespace UltimatR
{
    public interface IDsoSetToSet<TStore, TEntity> : IDso<TEntity>
    {
    }

    public interface IDsoToSet<TStore, TEntity> : IDso<TEntity>
    {
    }

    public interface IDsoSet<TStore, TEntity> : IDso<TEntity>
    {
    }
