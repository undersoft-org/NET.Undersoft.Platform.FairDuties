...
namespace EstimatR
{
    ...
    public class HyperCluster
    {
        ...
        public List<Item> HyperClusterItemList { get; set; } //redundant - analyse to delete it // should be private to have access by Get
        ...
        public bool RemoveClusterFromHyperCluster(Cluster cluster)
        {
            if (ClusterList.Remove(cluster) == true)
            {
                ...
                {
                    Clusterer.CalculateClusterIntersection(ClusterList, HyperClusterVector);
                    Clusterer.CalculateClusterSummary(ClusterList, HyperClusterVectorSummary);
        ...
        public List<Item> GetHyperClusterItemList()
        {
