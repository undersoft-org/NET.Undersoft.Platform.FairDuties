...
namespace System.Uniques
{
    ...
    public class UniqueBase : IUniqueEntry
    {
        private Uscn uniquecode;

        public UniqueBase() : this(true) { }

        public UniqueBase(bool autoId)
        {
            if (!autoId)
                return;
    ...
    public interface IUniqueEntry : IUnique
    {
        long Id { get; set; }
