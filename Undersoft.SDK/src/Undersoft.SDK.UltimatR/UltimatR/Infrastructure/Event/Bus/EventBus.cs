...
namespace UltimatR
{
    public class EventBus : EventBusBase, IEventBus
    {
        ...
        protected Catalog<EventWithHandlerFactories> HandlerFactories { get; set; }
            ...
            : base(serviceScopeFactory, eventHandlerInvoker)
        {
            ...
            HandlerFactories = new Catalog<EventWithHandlerFactories>();
        ...
        private EventWithHandlerFactories GetOrCreateHandlerFactories(Type eventType, IEventHandlerFactory factory = null)
        {
            ...
            return HandlerFactories.SureGet(eventType, (type) => new EventWithHandlerFactories(eventType, factory != null ? new List<IEventHandlerFactory>() { factory } : null)).Value;
        }
