...
namespace UltimatR
{
    public class RemoteLinkOnSet<TOrigin, TTarget> : RemoteLink<TOrigin, TTarget, DsoToSet<TTarget>> where TOrigin : class, IIdentifiable where TTarget : class, IIdentifiable
    {
