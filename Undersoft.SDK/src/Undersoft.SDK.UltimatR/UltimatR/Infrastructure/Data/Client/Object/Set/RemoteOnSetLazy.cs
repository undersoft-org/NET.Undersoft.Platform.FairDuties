...
namespace UltimatR
{
    public class RemoteOnSetLazy<TRemote> : Lazy<RemoteSet<TRemote>>, ICollection<TRemote>, IEnumerable<TRemote>, IFindable,
                                       IEnumerable, IList<TRemote>, IReadOnlyCollection<TRemote>, IReadOnlyList<TRemote>,
                                       ICollection, IList where TRemote : class, IIdentifiable
    {
        ...
        public RemoteOnSetLazy()
        {
        }

        public RemoteOnSetLazy(bool isThreadSafe) : base(isThreadSafe)
        {
        }

        public RemoteOnSetLazy(Func<RemoteSet<TRemote>> valueFactory) : base(valueFactory)
        {
        }

        public RemoteOnSetLazy(Func<RemoteSet<TRemote>> valueFactory, bool isThreadSafe) : base(valueFactory, isThreadSafe)
        {
        }

        public RemoteOnSetLazy(Func<RemoteSet<TRemote>> valueFactory, LazyThreadSafetyMode mode) : base(valueFactory, mode)
        {
        }

        public RemoteOnSetLazy(LazyThreadSafetyMode mode) : base(mode)
        {
        }

        public RemoteOnSetLazy(RemoteSet<TRemote> value) : base(value)
        {
        }
