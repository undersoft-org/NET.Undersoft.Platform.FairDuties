...
namespace UltimatR
{
    ...
    public class DboSetToSet<TLeft, TRight> : KeyedCollection<long, IDboRelation<TLeft, TRight>>, IFindable where TLeft : class, IIdentifiable where TRight : class, IIdentifiable
    {
