...
namespace UltimatR
{
    public static class OpenDataServiceRegistry
    {
        ...
        public static IEdmModel GetEdmModel(this DataServiceContext context)
        {
        ...
        public static async Task<IEdmModel> GetEdmModelAsync(this DataServiceContext context)
        {
