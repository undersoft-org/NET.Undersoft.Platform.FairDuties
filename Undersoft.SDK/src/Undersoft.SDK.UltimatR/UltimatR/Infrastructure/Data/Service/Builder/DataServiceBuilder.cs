...
namespace UltimatR
{
    public class DataServiceBuilder<TServiceStore> : DataServiceBuilder, IDataServiceBuilder<TServiceStore> where TServiceStore : IDataServiceStore
    {
        ...
        public DataServiceBuilder(string routePrefix, int pageLimit) : this()
        {
        ...
        public void BuildEdm()
        {
            ...
            var controllerTypes = asm.SelectMany(
                    a =>
                        a.GetTypes()
                            .Where(
                                type => type.GetCustomAttribute<ODataServiceAttribute>()
                                        != null
                            )
                            .ToArray())
                .Where(
