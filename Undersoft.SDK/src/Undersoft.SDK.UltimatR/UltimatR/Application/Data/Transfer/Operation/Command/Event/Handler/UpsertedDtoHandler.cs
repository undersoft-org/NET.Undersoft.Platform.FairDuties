...
namespace UltimatR
{
    public class UpsertedDtoHandler<TStore, TEntity, TDto> : INotificationHandler<UpsertedDto<TStore, TEntity, TDto> >
          where TEntity : Entity where TDto : Dto where TStore : IDataStore
    {
        ...
        public UpsertedDtoHandler(IEntityRepository<IReportStore, TEntity> repository,
        ...
        public virtual Task Handle(UpsertedDto<TStore, TEntity, TDto> request, CancellationToken cancellationToken)
        {
