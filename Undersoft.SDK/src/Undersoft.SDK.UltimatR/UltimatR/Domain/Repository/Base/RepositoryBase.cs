...
namespace UltimatR
{
    public abstract class Repository : IRepository
    {
        ...
        protected Repository(object context)
        {
            ...
            PatchingEvent = new Deputy(this.TracePatching);
        }
        ...
        {
            get => (serialcode.UniqueType == 0)
                ? serialcode.UniqueType = ContextType.UniqueKey32()
                : serialcode.UniqueType;
        ...
        public IDeputy PatchingEvent { get; set; }
