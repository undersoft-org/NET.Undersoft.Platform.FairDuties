...
namespace RadicalR
{
    public class DeletedSetHandler<TStore, TEntity, TDto> : INotificationHandler<DeletedSet<TStore, TEntity, TDto>>
        where TEntity : Entity where TDto : Dto where TStore : IDataStore
    {
        ...
        public DeletedSetHandler(IEntityRepository<IReportStore, TEntity> repository,
        ...
        public virtual Task Handle(DeletedSet<TStore, TEntity, TDto> request, CancellationToken cancellationToken)
        {
