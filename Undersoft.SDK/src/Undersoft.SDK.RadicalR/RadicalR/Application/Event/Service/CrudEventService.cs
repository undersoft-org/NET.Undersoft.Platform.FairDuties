...
namespace RadicalR
{
    [Route($"{StoreRoutes.Constant.CrudEventStore}/[controller]")]
    public abstract class CrudEventService<TKey, TStore, TEntity, TDto> : ControllerBase
        ...
        where TStore : IDataStore
    {
        ...
        protected CrudEventService(IRadicalr radicalr)
        {
            _radicalr = radicalr;
        }

        protected CrudEventService(
            IRadicalr radicalr,
