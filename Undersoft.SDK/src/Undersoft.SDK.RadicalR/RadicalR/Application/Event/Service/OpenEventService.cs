...
namespace RadicalR
{
    ...
    public abstract class OpenEventService<TKey, TStore, TEntity, TDto> : ODataController where TDto : Dto
        ...
        where TStore : IDataStore
    {
        ...
        {
            return _radicalr.Send(new FindQuery<TStore, TEntity, TDto>(_keymatcher(key)));
        }
