...
namespace RadicalR
{
    ...
    [LinkedResult]
    [OpenService]
    public class OpenDataService<TKey, TEntry, TReport, TEntity, TDto>
        : ODataController, IOpenDataService<TKey, TEntity, TDto> where TDto : Dto
        ...
        where TReport : IDataStore
    {
        ...
        {
            return _radicalr.Send(new FindQuery<TReport, TEntity, TDto>(_keymatcher(key)));
        }
