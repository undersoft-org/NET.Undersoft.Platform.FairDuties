...
namespace RadicalR
{
    [Route($"{StoreRoutes.Constant.RestEventStore}/[controller]")]
    public abstract class RestDataEventController<TKey, TStore, TEntity, TDto> : ControllerBase
        ...
        where TStore : IDataStore
    {
        ...
        protected RestDataEventController(IRadicalr radicalr)
        {
            _radicalr = radicalr;
        }

        protected RestDataEventController(
            IRadicalr radicalr,
        ...
        public virtual async Task<IActionResult> Patch([FromBody] TDto[] dtos)
        {
            ...
            DtoCommandSet<TDto> result = await _radicalr
        ...
        public virtual async Task<IActionResult> Patch(TKey key, [FromBody] TDto dto)
        {
            ...
            DtoCommand<TDto> result = await _radicalr
