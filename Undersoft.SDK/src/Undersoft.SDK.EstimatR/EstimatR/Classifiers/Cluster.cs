    ...
    public class Cluster
    {
        ...
        public bool RemoveItemFromCluster(SubjectItem item)
        {
            if (ClusterItemList.Remove(item) == true)
            {
                ...
                {
                    HyperAdaptiveResonainceClassifier.CalculateIntersection(ClusterItemList, ClusterVector);
                    HyperAdaptiveResonainceClassifier.CalculateSummary(ClusterItemList, ClusterVectorSummary);
        ...
        public void AddItemToCluster(SubjectItem item)
        {
            ...
            {
                ClusterItemList.Add(item);
                HyperAdaptiveResonainceClassifier.UpdateIntersectionByLast(ClusterItemList, ClusterVector);
                HyperAdaptiveResonainceClassifier.UpdateSummaryByLast(ClusterItemList, ClusterVectorSummary);
