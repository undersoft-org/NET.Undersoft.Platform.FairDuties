namespace EstimatR
{
    ...
    public class HyperCluster
    {
        ...
        public List<SubjectItem> HyperClusterItemList { get; set; } //redundant - analyse to delete it // should be private to have access by Get
        ...
        public HyperCluster(Cluster cluster)
        {
            ...
            //HyperClusterItemList = new List<Item>();
        ...
        public bool RemoveClusterFromHyperCluster(Cluster cluster)
        {
            if (ClusterList.Remove(cluster) == true)
            {
                ...
                {
                    HyperAdaptiveResonainceClassifier.CalculateClusterIntersection(ClusterList, HyperClusterVector);
                    HyperAdaptiveResonainceClassifier.CalculateClusterSummary(ClusterList, HyperClusterVectorSummary);
        ...
        {
            ClusterList.Add(cluster);
            HyperAdaptiveResonainceClassifier.UpdateClusterIntersectionByLast(ClusterList, HyperClusterVector);
            HyperAdaptiveResonainceClassifier.UpdateClusterSummaryByLast(ClusterList, HyperClusterVectorSummary);
        ...
        public List<SubjectItem> GetHyperClusterItemList()
        {
            ...
            //{
            List<SubjectItem> updatedItemList = new List<SubjectItem>();
