    ...
    public class HyperCluster
    {
        ...
        public bool RemoveClusterFromHyperCluster(Cluster cluster)
        {
            if (ClusterList.Remove(cluster) == true)
            {
                ...
                {
                    HyperAdaptiveResonainceTheory.CalculateClusterIntersection(ClusterList, HyperClusterVector);
                    HyperAdaptiveResonainceTheory.CalculateClusterSummary(ClusterList, HyperClusterVectorSummary);
        ...
        {
            ClusterList.Add(cluster);
            HyperAdaptiveResonainceTheory.UpdateClusterIntersectionByLast(ClusterList, HyperClusterVector);
            HyperAdaptiveResonainceTheory.UpdateClusterSummaryByLast(ClusterList, HyperClusterVectorSummary);
